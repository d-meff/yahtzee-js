...
let total_three_of_a_kind_value = document.getElementById("totalThreeOfAKindText");
let total_four_of_a_kind_value = document.getElementById("totalFourOfAKindText");
let total_small_straight_value = document.getElementById("totalSmallStraightText");
let total_large_straight_value = document.getElementById("totalLargeStraightText");
...
$(roll_dice_button).click(function() {
    current_dice = [Math.floor(Math.random() * 6) + 1, Math.floor(Math.random() * 6) + 1, Math.floor(Math.random() * 6) + 1,
...
$(submit_large_straight).click(function() {
    ...
    submit_large_straight.disabled = true;
    total_large_straight_value.innerText = 'Large Straight: ' + large_straight_total;
...
$(submit_three_of_a_kind).click(function() {
    ...
    submit_three_of_a_kind.disabled = true;
    total_three_of_a_kind_value.innerText = 'Three of a Kind: ' + three_of_a_kind_total;
...
$(submit_four_of_a_kind).click(function() {
    ...
    submit_four_of_a_kind.disabled = true;
    total_four_of_a_kind_value.innerText = 'Four of a Kind: ' + four_of_a_kind_total;
...
$(submit_small_straight).click(function() {
    var check_dice = [parseInt(dice_value_1.innerText), parseInt(dice_value_2.innerText), parseInt(dice_value_3.innerText), parseInt(dice_value_4.innerText), parseInt(dice_value_5.innerText)].sort();
    ...
    if (check_dice[0] < check_dice[1] && check_dice[1] < check_dice[2] && check_dice[2] < check_dice[3]) {
    ...
    submit_small_straight.disabled = true;
    total_small_straight_value.innerText = 'Small Straight: ' + small_straight_total;
...
$(submit_full_house).click(function() {
    ...
    if (remove_duplicates.length < 3) {
        ...
        if (FHval_total_1 == 3 && FHval_total_2 == 2 || FHval_total_1 == 2 && FHval_total_2 == 3) {
            full_house_total = 25;
        }
        else {
            full_house_total = 0;
